...
<div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
  ...
  <p class="text-sm text-gray-400 mt-2">proyectro de desarrollo web para profesionales</p>
  <img src="{{asset('images/dev.jfif')}}" class="absolute -right-10 -bottom-20 opacity-20">
</div>
